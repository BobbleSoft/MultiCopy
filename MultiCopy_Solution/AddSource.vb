Public Class AddSource
    ...
    Private Sub CheckOkButton()
        ...
        If Len(txtDir.Text.Trim()) > 0 Then
            If Len(txtFileSpec.Text.Trim()) > 0 Then
                enableIt = True
            End If
        End If
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        _OkClicked = True
        txtDir.Text = System.IO.Path.GetFullPath(txtDir.Text.Trim())
        txtFileSpec.Text = txtFileSpec.Text.Trim()
        If Len(txtFileSpec.Text) < 1 Then
            txtFileSpec.Text = "*.*"
        End If
        Me.Hide()
    End Sub
    ...
    Private Sub txtFileSpec_TextChanged(sender As Object, e As EventArgs) Handles txtFileSpec.TextChanged
        CheckOkButton()
    End Sub
End Class